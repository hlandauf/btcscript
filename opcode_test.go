...
var opcodeTests = []opcodeTest{
	...
	{script: []byte{btcscript.OP_0, btcscript.OP_IF, btcscript.OP_0, btcscript.OP_ELSE, btcscript.OP_2}, shouldFail: btcscript.ErrStackMissingEndif},
	{script: []byte{btcscript.OP_1, btcscript.OP_NOTIF, btcscript.OP_0, btcscript.OP_ELSE, btcscript.OP_2}, shouldFail: btcscript.ErrStackMissingEndif},
	...
	{script: []byte{btcscript.OP_ELSE, btcscript.OP_0, btcscript.OP_ENDIF}, shouldFail: btcscript.ErrStackNoIf},
	{script: []byte{btcscript.OP_ENDIF}, shouldFail: btcscript.ErrStackNoIf},
...
var detailedTests = []detailedTest{
	...
	},
	{
		...
		script:         []byte{btcscript.OP_PICK},
		expectedReturn: btcscript.ErrStackNumberTooBig,
		disassembly:    "OP_PICK",
	},
	{
		name:        "Roll1",
	...
	},
	{
		...
		before:         [][]byte{{1, 2, 3, 4}, {1, 2, 3, 3}},
		script:         []byte{btcscript.OP_EQUALVERIFY},
		expectedReturn: btcscript.ErrStackVerifyFailed,
		after:          [][]byte{},
		disassembly:    "OP_EQUALVERIFY",
	},
	{
	...
	},
	{
		...
		expectedReturn: btcscript.ErrStackShortScript,
		disassemblyerr: btcscript.ErrStackShortScript,
	},
	{
		name:        "op_pushdata_1",
		before:      [][]byte{},
	...
	},
	{
		...
		script: []byte{btcscript.OP_DATA_1, 21,
			btcscript.OP_CHECKMULTISIG},
		expectedReturn: btcscript.ErrStackTooManyPubkeys,
	...
	},
	{
		...
		expectedReturn: btcscript.ErrStackElementTooBig,
	...
	},
	{
		...
		expectedReturn: btcscript.ErrStackOpDisabled,
		disassembly:    "OP_CAT",
	},
	{
	...
	// Invalid Opcodes
	{
		...
		expectedReturn: btcscript.ErrStackInvalidOpcode,
...
func testOpcode(t *testing.T, test *detailedTest) {
	...
	if test.disassembly != "" {
		...
		if err != btcscript.ErrStackInvalidIndex {
